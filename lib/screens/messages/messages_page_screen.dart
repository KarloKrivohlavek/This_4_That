                      ...
                      return GestureDetector(
                        onTap: () {
                          Get.toNamed(MyRoutes.chatPageScreen,
                              arguments: controller.matchedItemsList
                                  .elementAt(index)
                                  .chatID);
                        },
                        child: MessagePreview(
                          currentUserItemImage: controller.matchedItemsList
                              .elementAt(index)
                              .item1PictureURL,
                          differentUserItemImage: controller.matchedItemsList
                              .elementAt(index)
                              .item2PictureURL,
                          differentUserName: controller.matchedItemsList
                              .elementAt(index)
                              .user2Username,
                          differentUserItemName: controller.matchedItemsList
                              .elementAt(index)
                              .item2Name,
                        ),
                      );
